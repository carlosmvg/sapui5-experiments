					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Aplicación drag and drop",
									"targetURL": "#dragdrop-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"dragdrop-display": {
								"semanticObject": "dragdrop",
								"action": "display",
								"description": "Aplicación drag and drop",
								"title": "Aplicación drag and drop",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=drag.drop",
									"url": sap.ui.require.toUrl("drag/drop")
								}
							}
						}
					}
